...
def hormone_strength(
    ...
    if adjustment:
        ...
        hormone_long_new_replace=hormone_long1

        ## add the prohormone and hormone list code section
        ...
        hormone_long=annotate_hormone_long(hormone_long_new_replace,hormone_producing,assay=assay,celltype_column=celltype_column)
